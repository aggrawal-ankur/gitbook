...
* [Understanding x64 Assembly](understanding-x64-assembly/README.md)
  ...
  * [Why Interpretation Is Important?](understanding-x64-assembly/why-memory-is-a-mess.md)
  * [User Input & Memory](understanding-x64-assembly/taking-user-input.md)
...
* [Project — ELF Parser](elf-parser/README.md)
  ...
  * [What are \`.h\` files?](elf-parser/whats-the-point-of-having-.c-and-.h-files.md)
  * [Magic Verification](elf-parser/magic-verification.md)
  * [What are the available APIs?](elf-parser/what-are-the-available-apis.md)
* [All Roads To Memory](all-roads-to-memory/README.md)
  ...
  * [Virtual Memory Layout](all-roads-to-memory/general-process-layout-in-virtual-memory.md)
  * [Address Translation](all-roads-to-memory/address-translation-and-and-page-walk-how-the-mmu-works.md)
* [Behind The Simplicity Of C Programs](how-x-exist-at-low-level/README.md)
  * [Storage Classes](how-x-exist-at-low-level/storage-classes.md)
  * [Arrays](how-x-exist-at-low-level/how-a-character-buffer-exist-and-managed-at-low-level.md)
  * [Format Specifiers](how-x-exist-at-low-level/the-story-of-format-specifiers.md)
